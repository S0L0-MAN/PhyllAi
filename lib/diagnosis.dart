...
class DiagnosisPage extends StatelessWidget {
  ...
  /// Helper function to read the JSON report generated by Python
  Future<Map<String, dynamic>> _loadReport() async {
    ...
    // Return empty map if Python hasn't finished writing yet
    return {};
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          // Extract data from JSON or use defaults if loading/missing
